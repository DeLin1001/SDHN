...
from .quadrotor_multi_wrapper import QuadrotorMultiWrapper
from .grid_maif_wrapper import GridMaifWrapper
...
def quadrotor_multi_fn(**kwargs) -> MultiAgentEnv:
    #assert "common_reward" in kwargs and "reward_scalarisation" in kwargs
    return QuadrotorMultiWrapper(**kwargs)

def grid_maif_fn(**kwargs) -> MultiAgentEnv:
    return GridMaifWrapper(**kwargs)


REGISTRY = {}
REGISTRY["smaclite"] = smaclite_fn
REGISTRY["gymma"] = gymma_fn
REGISTRY["quadrotor_multi"] = quadrotor_multi_fn
REGISTRY["grid_maif"] = grid_maif_fn
