...
if __name__ == "__main__":
    ...
    #vscode中的debug with arguments 传参会出现错误，因此采用release模式下执行并保存参数，debug下读取的方法 
    # import json
    ...
    # env_config = _get_config(deepcopy(params), "--env-config", "envs")
    # alg_config = _get_config(deepcopy(params), "--config", "algs")
    ...
    #print(params)
    #['src/main.py', 'with', 'env_args.time_limit=25', 'env_args.key=pz-mpe-simple-spread-v3']
